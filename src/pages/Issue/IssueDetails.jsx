...
import { ScrollArea } from "@/components/ui/scroll-area"; // Ensure this import matches the export in scroll-area.jsx
...
const IssueDetails = () => {
  ...
  const handleUpdateIssueStatus = (value) => {
    dispatch(updateIssueStatus({status:value,id:issueId}))
    ...
    <div className="px-20 py-8 text-gray-400">
      <div className="flex justify-between border p-10 rounded-lg">
        <ScrollArea className="h-[80vh] w-[60%]">
          <div>
            <h1 className="text-lg font-semibold text-gray-400">{issue.issueDetails
?.title}</h1>
